...
| `blackboard` | two SLM aliases + one LLM sweeper |
| `entropy_blackboard` | two SLM aliases + one LLM sweeper |
| `pure_swarm` | two SLM aliases, no LLM |

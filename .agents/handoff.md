...
- Repo model havuzu `core/model_catalog.py` içindeki seçilmiş alias'lara göre normalize edilmiştir; resmi checkpoint adları ile repo alias'larını karıştırma.

window.EATS_MATRIX = {
  ...
  rows: [
    ...
    { arch: 'Standalone (MoE)',      eats: [0.464, 0.488, 0.491, 0.481, 0.459] },
    { arch: 'Blackboard',            novel: true, eats: [0.535, 0.635, 0.643, 0.490, 0.345] },
    { arch: 'Entropy BB',            novel: true, eats: [0.524, 0.618, 0.649, 0.482, 0.384] },
    { arch: 'Active O.',             novel: true, eats: [0.568, 0.831, 0.557, 0.608, 0.458] },

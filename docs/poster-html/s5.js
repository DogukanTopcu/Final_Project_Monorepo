...
<section class="block">
  ...
  <p>Per-request measurements use GPU power sampling (NVIDIA NVML) at the inference host [4].</p>
  ...
  <div class="formula-note">k = 380 gCO₂/kWh (EU avg) · E in joules ÷ 3.6×10⁶</div>
</section>
`;

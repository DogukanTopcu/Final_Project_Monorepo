...
\begin{minipage}{0.48\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{blackboard_vertical.pdf}
  {\small Blackboard: SLM agents collaborate via a shared task board; an LLM sweeper intervenes when needed.}
\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}
  \centering
  \includegraphics[width=0.92\linewidth]{active_oracle_vertical.pdf}
  {\small Active Oracle: the SLM escalates targeted sub-queries to an LLM only at impasse points.}
\end{minipage}
\end{center}
}
